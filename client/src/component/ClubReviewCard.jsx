  ...
  return (
    <>
      ...
      className="cursor-pointer flex w-[340.6px] h-[114.89px] px-4 border-2 items-center justify-between rounded-[10px] relative">
        <div className=" mr-4">
          <img className="w-[81.48px] h-[81.48px] rounded-[10px]" src={eventReview.imageList[0]} alt="review_image"/>
        </div>
        <div className="flex justify-between flex-col w-[205px] h-full py-4">
          <div className="flex justify-between">
            ...
            <div className="text-[0.875rem] text-[#747474]">{`${eventReview.createdAt.split('T')[0].split('-')[1]}월 ${eventReview.createdAt.split('T')[0].split('-')[2]}일`}</div>
          </div>
          <div className="flex justify-between">

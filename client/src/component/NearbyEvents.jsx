...
function NearbyEvents() {
    ...
    const latlng = () => {
        ...
        getAPI(
            `/oneday/recommend?lat=${location?.latitude}&lon=${location?.longitude}`
        )
            .then((response) => {
                            ...
                            <div>
                                ...
                                <div className="flex flex-col items-center">
                                                    ...
                                                    <div className="w-[330px] h-[80px] flex flex-col justify-between items-center">
                                                        <div className="w-full h-[25px]   flex justify-between">
                                                            ...
                                                            <span className='text-[20px]'>
                                                                {d?.oneDayTitle.length > 7
                                                                    ? `${d?.oneDayTitle.substring(0, 12)}...`
                                                                    : d?.oneDayTitle}
                                                            </span>
                                                        ...
                                                        <div className="w-full h-[25px] flex justify-between text-[19px] text-[#A4A4A4]">
                                                            ...
                                                            <div>
                                                                {d.attendantsNum}/{d.oneDayGroupSize}명
                                                            </div>
                                    ...
                                    <div className="flex py-4">
                                        <button
                                            onClick={closeModal}
                                            className="flex justify-center items-center w-[50px] h-[50px] bg-white shadow-cms rounded-full"
                                        >
                                            X
                                        </button>
                                    </div>

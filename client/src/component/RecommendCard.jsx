      ...
      {page === "club" ? (
        ...
        >
          ...
          <div className=" flex-col flex items-center justify-centeroverflow-hidden rounded-xl">
            ...
            <div className="w-[219px] text-xl font-semibold whitespace-nowrap overflow-hidden overflow-ellipsis">
              {title}
            </div>
            <div className="w-[219px] text-sm font-semibold whitespace-nowrap overflow-hidden overflow-ellipsis">
              {content}
            </div>

    ...
    <>
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="pt-[116px] pb-[47px] text-4xl font-sans font-semibold w-full h-[230px] flex justify-center items-center">
            어떤 모임을 만들까요?
          </div>
          <div className="min-w-[1200px] self-center h-[screen] flex justify-center items-start py-40 bg-[#FFFCF2] border-[1px] rounded-t-3xl">
            ...
            <div className="flex flex-col items-center  gap-y-[60px]">
              ...
              <div className="flex flex-col items-center font-semibold text-[24px]">
                ...
                {modalContent() ? (
                  ...
                  <span className="text-[#08B159]">
                    아직 아무것도 저장되지 않았습니다!
                  </span>
                )}
                {savedOnedayData?.oneDayTitle ? (
                  <span className="text-[16px]">
                    모임명: {savedOnedayData?.oneDayTitle}
                  </span>
                ) : null}
              </div>

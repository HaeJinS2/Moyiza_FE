...
function Login() {
    ...
    const KAKAO_AUTH_URL = `http://13.125.51.14/oauth2/authorization/kakao?redirect_uri=https://mo2za.com/oauth/redirect`;
    const NAVER_AUTH_URL = `http://ec2-13-125-51-14.ap-northeast-2.compute.amazonaws.com/oauth2/authorization/naver?redirect_uri=https://mo2za.com/oauth/redirect`;
    const GOOGLE_AUTH_URL = `http://ec2-13-125-51-14.ap-northeast-2.compute.amazonaws.com/oauth2/authorization/google?redirect_uri=https://mo2za.com/oauth/redirect`;
